...
* **支持原生thrift、avro等跨语言的rpc框架**(2.8.5版开始支持)，只是非java语言的client调用dubbo的thrift/avro服务时，consumer无法享受dubbo的治理功能
...
* **dubbox-2.8.5**：
	* 合并了(杨俊明)项目中的一些修改（https://github.com/yjmyzz/dubbox）
    ...
    * 修改com.alibaba.dubbo.rpc.protocol.AbstractInvoker 第137行，改成每次都对async进行实际赋值（http://blog.csdn.net/windrui/article/details/52150345）
